...
import com.pagshq.murmurbox.entity.SelectedEmotionData
import com.pagshq.murmurbox.recyclerview.adapter.EmotionAdapter
import com.pagshq.murmurbox.recyclerview.data.EmotionData
...
class EmotionSelectionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        changeTopAndBottomColor(selectedEmotion.backgroundColor,true)
    ...
    private fun changeTopAndBottomColor(color: String,isLightColor: Boolean = false) {
        Log.e("Current Color",color)
        val resColor = if (color == "") {
            R.color.light_blue
        } else {
            color.toColorInt()
        }
